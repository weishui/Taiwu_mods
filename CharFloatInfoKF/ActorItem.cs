...
/*        private readonly bool isTarFeature;
        ...
        public ActorItem(int npcId)
        {
            ...
            if (isRank)
            {
                ...
                totalRankWeight[0] = 1;// ui.StrValue;
                totalRankWeight[1] = 1;// ui.ConValue;
                totalRankWeight[2] = 1;// ui.AgiValue;
                ...
                for (int tmpi = 0; tmpi < 16; tmpi++)
                    totalRankWeight[21 + tmpi] = 1;// ui.Skill[tmpi];
            }
